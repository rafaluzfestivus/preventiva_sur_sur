...
export const metadata: Metadata = {
    title: 'Política de Privacidad | Preventiva Sur',
    description: 'Política de Privacidad y Protección de Datos de Preventiva Sur.',
};
    ...
    return (
        <div className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none text-slate-700">
                <p>
                    En Preventiva Sur, nos comprometemos a proteger y respetar su privacidad. Esta Política de Privacidad explica cómo recopilamos, utilizamos y protegemos sus datos personales de acuerdo con el Reglamento General de Protección de Datos (RGPD) de la Unión Europea y la legislación española vigente.
                </p>

                <h2 className="text-2xl font-bold mt-8 mb-4 text-slate-900">1. Responsable del Tratamiento</h2>
                <p>
                    Los datos personales recabados a través de este sitio web son responsabilidad de Preventiva Sur.<br />
                    <strong>Correo electrónico de contacto:</strong> contacto@preventivasur.com<br />
                    <strong>Teléfono:</strong> 615 744 742<br />
                    Ubicación: Málaga, Andalucía (Prestamos servicio en toda el Área Metropolitana de Málaga y Andalucía).
                </p>
                ...
                <p>
                    Preventiva Sur se reserva el derecho de modificar esta política para adaptarla a novedades legislativas o jurisprudenciales. Se recomienda su lectura periódica.
                </p>
