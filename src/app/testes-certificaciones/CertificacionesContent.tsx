    ...
    const specs = [
        {
            ...
            text: "Equipadas con doble tratamiento Anti-UV y antioxidantes. Soportan la intensa radiación solar de Andalucía sin cristalizarse ni perder su color. Este componente técnico es lo que nos permite ofrecer una garantía real de durabilidad."
        },
        {
        ...
        },
        {
            ...
            text: "Con un grosor optimizado de 0.8mm a 1mm, nuestras redes ofrecen un impacto visual mínimo. Son aceptadas por la mayoría de las comunidades de vecinos en Málaga y Andalucía."
        }
    ];
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed">
                            En Preventiva Sur, la seguridad no es una promesa, es una certificación técnica.
                            Utilizamos materiales de última generación diseñados para resistir las condiciones climáticas de Andalucía.
                        </p>
                    </motion.div>
                </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed mb-12">
                        ...
                        diseñados para anclarse firmemente en ladrillo, hormigón o estructuras metálicas de los edificios de Málaga, sin riesgo de desprendimiento.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-8 text-center">
                    <div className="bg-[#4d2a36] rounded-3xl p-12 text-white shadow-2xl">
                        ...
                        <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
                            Solicita una visita técnica gratuita en Málaga y comprueba la calidad de nuestros materiales.
                        </p>
                        <Link
                            href="/#contacto"
