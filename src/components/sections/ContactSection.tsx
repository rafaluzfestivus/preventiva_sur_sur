...
export function ContactSection() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const data = {
            access_key: "COLOQUE_AQUI_SUA_WEB3FORMS_KEY",
            ...
            subject: "Nuevo mensaje desde Preventiva Sur"
        };
        ...
        try {
            ...
            await Promise.allSettled([
                ...
                fetch("https://fluxo.festivusia.com/webhook/emailpreventivasur", {
                    method: "POST",
                    headers: { "Content-Type": "application/json", "Accept": "application/json" },
                    body: JSON.stringify({
                        ...data,
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl mb-1">WhatsApp / Móvil</h3>
                                    <a href="https://wa.me/34615744742" className="text-slate-300 hover:text-white transition-colors text-lg" target="_blank" rel="noopener noreferrer">
                                        615 744 742
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl mb-1">Teléfono Fijo</h3>
                                    <a href="tel:+34952009498" className="text-slate-300 hover:text-white transition-colors text-lg">
                                        952 009 498
                                    </a>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" name="codigoPostal" value={formData.codigoPostal} onChange={handleChange} required className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 outline-none transition-all" placeholder="29000" />
                                        </div>
                                        <div>
