...
export function WhyUs() {
    const reasons = [
        ...
        },
        {
            ...
            title: "Atención Ágil",
            description: "Presupuestos por WhatsApp en menor tiempo y plazos de instalación mínimos en Málaga y toda Andalucía.",
        },
        {
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/3">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            ...
                            <span className="text-yellow-400">Preventiva Sur?</span>
                        </h2>
                        <p className="text-slate-300 text-lg leading-relaxed mb-8">
                            Unimos la experiencia internacional con el servicio local en Málaga para ofrecerte la máxima seguridad sin comprometer la estética de tu hogar.
                        </p>
