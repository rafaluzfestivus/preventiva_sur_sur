        ...
        <footer className="bg-[#4d2a36] text-gray-300 pt-16 pb-8">
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm leading-relaxed">
                            Especialistas en la instalación de redes de protección de alta resistencia en Málaga y Andalucía.
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <a href="https://www.instagram.com/preventivasur/" className="hover:text-rose-500 transition-colors" target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    <span className="text-xs text-slate-400 font-bold uppercase block">WhatsApp / Móvil</span>
                                    <a href="https://wa.me/34615744742" className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">615 744 742</a>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <Phone className="w-5 h-5 text-yellow-400 shrink-0 mt-1" />
                                <div>
                                    <span className="text-xs text-slate-400 font-bold uppercase block">Fijo</span>
                                    <a href="tel:+34952009498" className="hover:text-white transition-colors">952 009 498</a>
                                </div>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="w-5 h-5 text-yellow-400 shrink-0" />
                                <a href="mailto:contacto@preventivasur.com" className="hover:text-white transition-colors">contacto@preventivasur.com</a>
                            </li>
                            <li className="flex items-start gap-3">
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
                    <p>&copy; {new Date().getFullYear()} Preventiva Sur. Todos los derechos reservados.</p>
